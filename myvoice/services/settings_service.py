...
Atomic writes (tmpfile+rename), schema versioning, safe defaults.
Never raises on read errors — falls back to defaults and logs.
"""
...
class Settings:
    ...
    # freedesktop desktop-file id like "org.x.editor.desktop".
